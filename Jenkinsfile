pipeline {
  ...
  environment {
    ...
    EXT_USER = 'darkalfx'
    EXT_REPO = 'requestrr'
    BUILD_VERSION_ARG = 'REQUESTRR_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-requestrr'
    CONTAINER_NAME = 'requestrr'
    DOCKERHUB_IMAGE = 'linuxserver/requestrr'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/requestrr'
    PR_DOCKERHUB_IMAGE = 'lspipepr/requestrr'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-requestrr/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-requestrr\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-requestrr\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Requestrr\" \
          --label \"org.opencontainers.image.description=[Requestrr](https://github.com/darkalfx/requestrr) is a chatbot used to simplify using services like Sonarr/Radarr/Ombi via the use of chat.\" \
